// Copyright (c) 2014 The Evarians developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("evarians-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("evarians-smsg-pow"); // Make this thread recognisable
