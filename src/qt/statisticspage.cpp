...
void StatisticsPage::updateStatistics()
{
    ...
    {
        subsidy = "300 EVS per block";
    }
	else if (pindexBest->nHeight < 2000000)
    {
        subsidy = "200 EVS per block";
    }
	else if (pindexBest->nHeight < 3000000)
    {
        subsidy = "100 EVS per block";
    }
    else if (pindexBest->nHeight > 3000000)
    {
        subsidy = "Full PoS";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " EVS" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " EVS" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " EVS" + "</font></b>");
    }
